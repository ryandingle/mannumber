...
$(document).on('click', '.view_modal', function () {
	...
	if (modal == '') {
		console.log('Please specify modal name.');alert('Please specify modal name.');return false;
	}
	if (method == '') {
		console.log('Please specify method name.');alert('Please specify method name.');return false;
	}
	if (module == '') {
		console.log('Please specify module name.');alert('Please specify module name.');return false;
	}
